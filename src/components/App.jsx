      ...
      <main className="main">
        <section className="section-principal">
          ...
          <div className="section-principal__couple">
            <p className="section-principal__couple--name">Jamie</p>
        ...
        <section className="section-places">
          <div className="ceremony">
            <p className="ceremony__title">Ceremonia</p>
            <a href="https://maps.app.goo.gl/jUXnbtMkMD7exVN48" target="_blank">
              <img
                src={church}
                alt="Iglesia de Glencorse"
                className="ceremony__img"
              />
            </a>
            
            <p className="ceremony__church">Glencorse Old Kirk</p>
            <p className="ceremony__time">17:00</p>
            <iframe
              ...
              className="ceremony__map"
            ></iframe>
          </div>
          <div className="celebration">
            <p className='celebration__title'>Celebración</p>
            <a href="https://maps.app.goo.gl/UNmd2EcyWEU4KLT68" target="_blank">
              <img src={leoch} alt="" className="celebration__img" /></a>
              <p className='celebration__castle'>Castillo de Doune</p>
              <p className='celebration__time'>20:00</p>
              <iframe
            ...
            <button className="section-places__btn" onClick={handleAddToCalendar}>Agregar a calendario</button>
          
        </section>
        <section className='photos'>
          <h2 className='photos__title'>Compartiendo este día junto a tí</h2>
          ...
          <ul className='photos__wedshoots'>
            <li className='photos__wedshoots--p'>
              Descarga la App de <a href="www.wedshoots.com">Wedshoots</a>
            </li>
            <li className='photos__wedshoots--p'>
          ...
          <p className='photos__ig'><i className="fa-brands fa-instagram photos__ig--icon"></i>
